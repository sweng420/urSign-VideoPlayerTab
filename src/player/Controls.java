	...
	public Controls (Player player) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                //YSS EDIT
                //
                //Removed stop button so so it doesn't not close window
                //
                //YSS EDIT
				 	...
				 	if (over == false) {
						Platform.runLater(new Runnable(){
							...
							public void run() {
								...
								//YSS EDIT
								//
								//Removed automatic loading of next video
								//
								//YSS EDIT
//								else {
...
//								}
	...
	//YSS EDIT
	//
	//Added method to disable/enable all buttons
	//
	//YSS EDIT
	
	/**
	 * Method for disabling or enabling all controls
	 * @return 
	 */
	public void disableButtons(boolean value){
		this.play_pause.setDisable(value);
		this.next.setDisable(value);
		this.previous.setDisable(value);
		this.time_scrubber.setDisable(value);
		this.volume.setDisable(value);
	}
